...
//=================================================//
CFonts.say("SC GRANTLY BY WILTER", {
   font: 'chrome',
  align: 'left',
...
//await sleep(400)  
console.log(color(`─[`,`magenta`),`「`,  color(`willy_a332`,`red`), `」`,  color(`]─`,`magenta`))
//await sleep(400)  
start(`1`,`Connecting...`)
} else if (connection === "open") {
  oka.sendMessage('6285860703158' + "@s.whatsapp.net", { text: `*halo Wilter*
  Telah Terhubung!!
  
  *_Jangan Lupa Untuk Masuk GC Wilter Untuk Mendapatkan Info Terbaru.*
  
  *https://www.tiktok.com/@willy_a332.*` });
  success(`1`,`[■■■■■■■■■■■■■■■] Connected`) 
}
