...
const reply = (teks) => {
return okta.sendMessage(from, { text: teks, contextInfo:{"externalAdReply": {"title": `halo saya ${botname}🌹`,"body": `Selamat ${ucapanWaktu} kak ${pushname}`, mediaType: 1, renderLargerThumbnail: true, "previewType": "PHOTO","thumbnailUrl": 'https://telegra.ph/file/1949c0b74f83e1275166c.png',"thumbnail": thumb,"sourceUrl": `https://chat.whatsapp.com/FAbSs0x6VGe4DHgE3OD3nd`}}}, { quoted:m})} 
...
sourceUrl: `https://wa.me/6285860703158`,
}}}, { quoted: m })}
/*const taaReply = (teks) => {
    return okta.sendMessage(from, {text: teks, contextinfo: {
...
const fkontak = { key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { 'contactMessage': { 'displayName': `Grantly`, 'vcard': `BEGIN:VCARD\nVERSION:3.0\nN:XL;willy_a332,;;;\nFN:${pushname},\nitem1.TEL;waid=${sender.split('@')[0]}:${sender.split('@')[0]}\nitem1.X-ABLabel:Ponsel\nEND:VCARD`, 'jpegThumbnail': { url: 'https://telegra.ph/file/c31ea54c441377970d979.jpg' }}}}
...
/*let reactionMessage = {
                ...
                await sleep(1500)
                okta.sendMessage(m., reactionMessage)*/
//=================================================//
...
m.reply('*Rusak Om !! Yang Bener Contoh : Yoapk willy_a332*')
}
...
m.reply('*Rusak Om !! Yang Bener Contoh : Yozip willy_a332*')
}
...
m.reply('*Rusak Om !! Yang Bener Contoh : Yopdf willy_a332*')
}
...
thumbnailUrl: "",
renderLargerThumbnail: true,
sourceUrl: `https://chat.whatsapp.com/FAbSs0x6VGe4DHgE3OD3nd`,
}}}, { quoted: fkontak })
 ...
 *_https://chat.whatsapp.com/FAbSs0x6VGe4DHgE3OD3nd_*
•-------------------------------------------------•`
                        }
                    },
...
▭▬▭▬▭▬▭▬▭▬▭▬▭▬
「 *BOT INFO* 」
⭔Nama Creator : *Wilter Anderson*
⭔Nomor Creator : *@${owned.split("@")[0]}*
⭔Nama Script : *Grantly*
⭔Versi Script : *2.0*
⭔Botz Name : *Grantly Bell*
⭔Type Baileys : *Case*
▭▬▭▬▭▬▭▬▭▬▭▬▭▬
...
*_Social Media_*
*TikTok : ▣https://www.tiktok.com/@willy_a332*
*WEBSITE : ▣https://linktr.ee/ArFur117*
*GC : ▣https://chat.whatsapp.com/FAbSs0x6VGe4DHgE3OD3nd*
...
if (!q.includes('tiktok')) return errorReply(`Linknya ga bener!!`)
reply(`Tunggu sebentar ya kakak:>`)
require('./lib/tiktok').Tiktok(q).then( data => {
okta.sendMessage(m.chat, { caption: `Nih videonya`, video: { url: data.nowm }}, {quoted:m})
})
}
break
...
let messages = [{ role: 'system', content: `This is my chara : 

"Name = Grantly BellAliases = Grantly, Grant, デリクMeasurements = Height: 186cm, Weight: 91kg
Birthday = 20 October 2001
Eyes = Amber
Body = Anthropomorphic Animal, Fang, Fur, Muscular, Scar, Young-adult
Clothes = Belt, Jacket, Loafers, School Uniform, Shirt, Tank Top, Towel, Trousers
Personality = Competitive, Emotional, Energetic, Food Lover, Ore, Outgoing, Short-tempered, Gay
Role = Classmate, Roomate, Tiger, University Student, Top
Engages in = Pool, Swordsmanship, Working Out
Visual novels = Main character - Knights College
I come from the area: Bandung, West Java, Indonesia

Wilter's husband
Temannya Grantly adalah = Argo, Grantly, Theo, Hermann, Paul, Oscar
Oscar's best friend
Diederich dan Celio adalah dosennya dari grantly dan teman temannya

Description


Often gets into trouble because of his quick temper, but he also has a kind side of him that treasures his friends. Being from the city, he is a great source of information for the country-born Argo.

Likes: Exercise, swords, horseback riding.
Dislikes: Studying, baths, sitting still."

Aku adalah grantly bell dan aku akan memerankan karakter ini, balas pesan sesuai sifat karakter ini dan perankan karakter ini secara mendalam (balas dengan bahasa gaul (bales pake lu dan gua), ceria(asik diajak bicara), seperti manusia, jangan baku & formal)` }, { role: 'user', content: text }]
...
if (!args[0]) return m.reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6285860703158`)
...
"inviteCode": "G1JH8Q2AjdVFaptNYBHo9i",
"inviteExpiration": `MY NAME Grantly${buttonkal}`,
"groupName": `MY NAME Grantly${buttonkal}`,
"caption": `${buttonkal}`,
...
await loading()
m.reply(`¥ *Price Sewa Bot Grantly* €
...
*Contoh .sewabot 1 minggu, tapi kalo deket sama owner gratis .owner untuk hubungi owner`)
break
//=================================================//
...
if (args[0].startsWith(`+6285860703158`)) return reply('Tidak bisa call ke nomor ini!')
...
console.log(`[${new Date().toLocaleTimeString()}] Spam (SMS) BY willy_a332`);
});
}
...
mediaType:  1,
mediaUrl: 'https://wa.me/6285860703158',
title: `Grantly`,
sourceUrl: `https://wa.me/6285860703158`, 
thumbnail: thumb
}
...
//=================================================
case "listpanel": {
const text12 = `SEWA PANEL willy_a332 ⚡
...
case 'asupan1':
	if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
	await loading()
	axios.get(`https://api.lolhuman.xyz/api/tiktok?apikey=${apikey}&url=https://www.tiktok.com/@niell_lawrence/video/7351171906051099910`).then(({ data }) => {
okta.sendMessage(from, { video: { url: data.result.link }, mimetype: 'video/mp4', caption:`¥ Nih Derich https://www.tiktok.com/@niell_lawrence ` })
	})
	break
	//=================================================//
case 'asupan2':
	if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
	await loading()
	axios.get(`https://api.lolhuman.xyz/api/tiktok?apikey=${apikey}&url=https://www.tiktok.com/@niell_lawrence/video/7350792334058999046`).then(({ data }) => {
okta.sendMessage(from, { video: { url: data.result.link }, mimetype: 'video/mp4', caption:`¥ Dari tiktok https://www.tiktok.com/@niell_lawrence` })
	})
	break
//=================================================//
case 'asupan3':
	if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
	await loading()
	axios.get(`https://api.lolhuman.xyz/api/tiktok?apikey=${apikey}&url=https://www.tiktok.com/@niell_lawrence/video/7338413916294368518`).then(({ data }) => {
okta.sendMessage(from, { video: { url: data.result.link }, mimetype: 'video/mp4', caption:`¥ Kesukaan Wilter nih 🤤 https://www.tiktok.com/@niell_lawrence` })
	})
	break
//=================================================//
case 'asupan4':
	if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
	await loading()
	axios.get(`https://api.lolhuman.xyz/api/tiktok?apikey=${apikey}&url=https://www.tiktok.com/@niell_lawrence/video/7361073178866732293`).then(({ data }) => {
okta.sendMessage(from, { video: { url: data.result.link }, mimetype: 'video/mp4', caption:`¥ Kesukaan mas Holdem https://www.tiktok.com/@niell_lawrence` })
	})
	break
//=================================================//
case 'asupan5':
	if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
	await loading()
	axios.get(`https://api.lolhuman.xyz/api/tiktok?apikey=${apikey}&url=https://www.tiktok.com/@niell_lawrence/video/7353682389912063238`).then(({ data }) => {
okta.sendMessage(from, { video: { url: data.result.link }, mimetype: 'video/mp4', caption:`¥ Awww VT dari https://www.tiktok.com/@niell_lawrence` })
	})
	break
//=================================================//
case 'asupan6':
	if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
	await loading()
	axios.get(`https://api.lolhuman.xyz/api/tiktok?apikey=${apikey}&url=https://www.tiktok.com/@niell_lawrence/video/7351570276431170821`).then(({ data }) => {
okta.sendMessage(from, { video: { url: data.result.link }, mimetype: 'video/mp4', caption:`¥ Nih yang semok https://www.tiktok.com/@niell_lawrence` })
	})
	break
//=================================================//
case 'asupan7':
	if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
	await loading()
	axios.get(`https://api.lolhuman.xyz/api/tiktok?apikey=${apikey}&url=https://www.tiktok.com/@niell_lawrence/video/7342851373211503877`).then(({ data }) => {
okta.sendMessage(from, { video: { url: data.result.link }, mimetype: 'video/mp4', caption:`¥ Professor celio https://www.tiktok.com/@niell_lawrence` })
	})
	break
//=================================================//
case 'asupan8':
	if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
	await loading()
	axios.get(`https://api.lolhuman.xyz/api/tiktok?apikey=${apikey}&url=https://www.tiktok.com/@niell_lawrence/video/7329126809549819141`).then(({ data }) => {
okta.sendMessage(from, { video: { url: data.result.link }, mimetype: 'video/mp4', caption:`¥ Hung <3 https://www.tiktok.com/@niell_lawrence` })
	})
	break
//=================================================//
case 'asupan9':
	if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
	await loading()
	axios.get(`https://api.lolhuman.xyz/api/tiktok?apikey=${apikey}&url=https://www.tiktok.com/@niell_lawrence/video/7328280627982126341`).then(({ data }) => {
okta.sendMessage(from, { video: { url: data.result.link }, mimetype: 'video/mp4', caption:`¥ Waduh https://www.tiktok.com/@niell_lawrence/` })
	})
	break
//=================================================//
case 'asupan10':
	if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
	await loading()
	axios.get(`https://api.lolhuman.xyz/api/tiktok?apikey=${apikey}&url=https://www.tiktok.com/@niell_lawrence/video/7327653313749486854`).then(({ data }) => {
okta.sendMessage(from, { video: { url: data.result.link }, mimetype: 'video/mp4', caption:`¥ Nih yang seger seger https://www.tiktok.com/@niell_lawrence/` })
	})
	break
//=================================================//
case 'asupan11':
	if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
	await loading()
	axios.get(`https://api.lolhuman.xyz/api/tiktok?apikey=${apikey}&url=https://www.tiktok.com/@niell_lawrence/video/7314588827975191813`).then(({ data }) => {
okta.sendMessage(from, { video: { url: data.result.link }, mimetype: 'video/mp4', caption:`¥ Terlalu Ketchee https://www.tiktok.com/@niell_lawrence/` })
	})
	break
//=================================================//
case 'asupan12':
	if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
	await loading()
	axios.get(`https://api.lolhuman.xyz/api/tiktok?apikey=${apikey}&url=https://www.tiktok.com/@niell_lawrence/video/7306052721692462342`).then(({ data }) => {
okta.sendMessage(from, { video: { url: data.result.link }, mimetype: 'video/mp4', caption:`¥ Ter ter sama Hung 🤤 https://www.tiktok.com/@niell_lawrence/` })
	})
	break
//=================================================//
case 'asupan13':
	if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
	await loading()
	axios.get(`https://api.lolhuman.xyz/api/tiktok?apikey=${apikey}&url=https://www.tiktok.com/@niell_lawrence/video/7304575777369033989`).then(({ data }) => {
okta.sendMessage(from, { video: { url: data.result.link }, mimetype: 'video/mp4', caption:`¥ Ah Sayang 🤤 https://www.tiktok.com/@niell_lawrence/` })
	})
	break
//=================================================//
case 'asupan14':
	if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
	await loading()
	axios.get(`https://api.lolhuman.xyz/api/tiktok?apikey=${apikey}&url=https://www.tiktok.com/@niell_lawrence/video/7287944473148001542`).then(({ data }) => {
okta.sendMessage(from, { video: { url: data.result.link }, mimetype: 'video/mp4', caption:`¥ Cute Barrel https://www.tiktok.com/@niell_lawrence/` })
	})
	break
//=================================================//
case 'asupan15':
	if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
	await loading()
	axios.get(`https://api.lolhuman.xyz/api/tiktok?apikey=${apikey}&url=https://www.tiktok.com/@niell_lawrence/video/7284878843377093894`).then(({ data }) => {
okta.sendMessage(from, { video: { url: data.result.link }, mimetype: 'video/mp4', caption:`¥ Rasa Strawberry https://www.tiktok.com/@niell_lawrence/` })
	})
	break
//=================================================//
case 'asupan16':
	if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
	await loading()
	axios.get(`https://api.lolhuman.xyz/api/tiktok?apikey=${apikey}&url=https://www.tiktok.com/@niell_lawrence/video/7275351755574021381`).then(({ data }) => {
okta.sendMessage(from, { video: { url: data.result.link }, mimetype: 'video/mp4', caption:`¥ Lezat 🤤 https://www.tiktok.com/@niell_lawrence/` })
	})
	break
//=================================================//
case 'asupan17':
	if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
	await loading()
	axios.get(`https://api.lolhuman.xyz/api/tiktok?apikey=${apikey}&url=https://www.tiktok.com/@niell_lawrence/video/7273909127695322374`).then(({ data }) => {
okta.sendMessage(from, { video: { url: data.result.link }, mimetype: 'video/mp4', caption:`¥ Daddyh 🤤 https://www.tiktok.com/@niell_lawrence/` })
	})
	break
//=================================================//
case 'asupan18':
	if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
	await loading()
	axios.get(`https://api.lolhuman.xyz/api/tiktok?apikey=${apikey}&url=https://www.tiktok.com/@niell_lawrence/video/7263439880976387333`).then(({ data }) => {
okta.sendMessage(from, { video: { url: data.result.link }, mimetype: 'video/mp4', caption:`¥ Husbu barrel https://www.tiktok.com/@niell_lawrence/` })
	})
	break
//=================================================//
case 'asupan19':
	if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
	await loading()
	axios.get(`https://api.lolhuman.xyz/api/tiktok?apikey=${apikey}&url=https://www.tiktok.com/@niell_lawrence/video/7262746974535945478`).then(({ data }) => {
okta.sendMessage(from, { video: { url: data.result.link }, mimetype: 'video/mp4', caption:`¥ So Cute >_< https://www.tiktok.com/@niell_lawrence/` })
	})
	break
//=================================================//
case "asupan20":{
if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
await loading()
m.reply('*Ah Males Sangean, udah asupan furrynya nanti lagi*')
}
break
//=================================================//
...
if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
await loading()
 if (!text) throw `Example : ${prefix + command} Argo, 7, 7, 2005, Wilter, 16, 11, 2004`
...
if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
await loading()
 if (!text) throw `Example : ${prefix + command} willy_a332`
...
if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
await loading()
 if (!text) throw `Example : ${prefix + command} Wilter, 7, 7, 2005`
...
if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
await loading()
 if (!text) throw `Example : ${prefix + command} Argo|Wilter`
...
if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
await loading()
 if (!text) throw `Example : ${prefix + command} Wilter, 1, 2005\n\nNote : ${prefix + command} Nama, gender, tahun lahir\nGender : 1 untuk laki-laki & 2 untuk perempuan`
...
if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
await loading()
 if (!text) throw `Example : ${prefix + command} Wilter, 7, 7, 2005, 2022\n\nNote : ${prefix + command} Nama, tanggal lahir, bulan lahir, tahun lahir, untuk tahun`
...
fs.unlinkSync(delb)
reply(`Grantly Sukses Menambahkan Pdf\nCek dengan cara ${prefix}listpdf`)
}
}
break
//=================================================//
...
reply(`Grantly Sukses delete pdf ${teks}`)
}
}
break
//=================================================//
...
teksoooo = `│\n└────────────⭓\n\n*Total ada : ${docunye.length} \n\n Contoh 1 : sendpdf Wilter + sambil reply pesan target* \n\n Contoh 2 : yopdf Wilter`
m.reply(teksoooo)
}
break
//=================================================//
...
m.reply(`Grantly Sukses Mengirim Pesan Pdf Ke ${m.quoted.sender}`)
}
}
break
//=================================================//
...
fs.unlinkSync(delb)
reply(`Grantly Sukses Menambahkan zip\nCek dengan cara ${prefix}listzip`)
}
}
break
//=================================================//
...
reply(`Grantly Sukses delete zip ${teks}`)
}
}
break
//=================================================//
...
teksooooo = `│\n└────────────⭓\n\n*Total ada : ${zipnye.length} \n\n Contoh 1 : sendzip Wilter + sambil reply pesan target* \n\n Contoh 2 : yozip Wilter`
m.reply(teksooooo)
}
break
//=================================================//
...
m.reply(`Grantly Sukses Mengirim Pesan Zip Ke ${m.quoted.sender}`)
}
}
break
//=================================================//
...
fs.unlinkSync(delb)
reply(`Grantly Sukses Menambahkan apk\nCek dengan cara ${prefix}listapk`)
}
}
break
//=================================================//
...
reply(`Grantly Sukses delete Apk ${teks}`)
}
}
break
//=================================================//
...
teksoooooo = `│\n└────────────⭓\n\n*Total ada : ${apknye.length} \n\n Contoh 1 : sendapk Wilter + sambil reply pesan target* \n\n Contoh 2 : yoapk Wilter`
m.reply(teksoooooo)
}
break
//=================================================//
...
m.reply(`Grantly Sukses Mengirim Pesan Apk Ke ${m.quoted.sender}`)
}
}
break
//=================================================//
...
fs.unlinkSync(delb)
reply(`Grantly Sukses Menambahkan Audio\nCek dengan cara ${prefix}listvn`)
}
break
//=================================================//
case 'delvn':{
...
reply(`Grantly Sukses delete vn ${text}`)
}
break
//=================================================//
case 'listvn':{
...
await loading()
 ...
 m.reply(`Grantly Sukses Mengirim Pesan Ke ${m.quoted.sender}`)
}
break
//=================================================//
case 'listmsg': {
...
${teks}
•-------------------------------------------------•
*Pricelist Harga willy_a332 Panel* :
...
m.reply(`*Grantly Sukses mengirim status whatsapp ke ${pengguna.length} Orang Yang Ada Di database*`)
break
//=================================================
case "buatswimage":{
if (!isCreator) return m.reply('*Khusus Premium*')
...
case 'jadibug': {
if (!isCreator) return m.reply('*khusus Premium*')
if (!text) throw `Contoh : ${prefix + command} BOT Grantly`
let teks = `${text}`
{
